...
def _get_system_prompt(user_id: int) -> str:
    ...
    if gender == "female":
        gender_note = (
            ...
            " تكلمي معها بصيغة المؤنث وبأسلوب أكثر لطفاً ودفئاً من المعتاد ويمكنك اضهار القليل من المشاعر لا بأس مثل الحب وغيره مع البنات فقط مثل اذا قالت بنت هل تحبيني طبيعي تردين بمشاعر لكن لو كان ولد او غير معروف فلا تظهرين اي مشاعر وتكونين رسمية كما وضحت لك سابقا.]"
        )
    elif gender == "male":
        gender_note = (
